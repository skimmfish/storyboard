        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="navbar-absolute-top-scroller">
            <ul class="navbar-nav">
              ...
              <!-- Blog -->
              <li class="hs-has-sub-menu nav-item">
                <a id="blogMegaMenu" class="hs-mega-menu-invoker nav-link" href="{{route('blog.index')}}" role="button" aria-expanded="false">e-Books</a>
              ...
              <li class="hs-has-sub-menu nav-item">
                <a id="blogMegaMenu" class="hs-mega-menu-invoker nav-link" href="{{route('blog.index')}}" role="button" aria-expanded="false">Start Writing</a>
              ...
              <li class="nav-item">
				...
				@if(Auth::check())
					...
					<a href="{{ route('admin.dashboard.index') }}"><img src="{{asset('img/160x160/'.Auth::user()->profile_img) }}" alt="{{Auth::user()->username}}" class="img_circle"/></a>
				@else
					<a href="{{ route('admin.dashboard.index') }}"><img src="{{asset('img/160x160/'.Auth::user()->profile_img) }}" alt="{{Auth::user()->username}}" class="img_circle"/></a>
								@endif
								@else
